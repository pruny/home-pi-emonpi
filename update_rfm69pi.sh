...
if [ -f /home/pi/data/firmware/rfm69pi-$version.hex ]; then
  ...
  echo "================================="
  echo
  echo "Flashing ATMEGA with RFM69Pi-V" $version
  echo
  avrdude -v -c arduino -p ATMEGA328P -P /dev/ttyAMA0 -b 57600 -U flash:w:/home/pi/data/firmware/rfm69pi-$version.hex
  sudo service emonhub start
  echo "Flashing ATMEGA with RFM69Pi-V" $version " done"
else
